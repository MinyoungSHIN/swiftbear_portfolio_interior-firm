...
export const metadata = {
  ...
  description:
    "15년 경력 인테리어 전문 기업 스페이스온. 3D 사전 확인·투명 견적·2년 A/S 보증으로 1,200건 이상 완공. 무료 상담 신청하세요.",
  openGraph: {
    title: "스페이스온 — 공간이 바뀌면 삶이 달라집니다",
    description: "15년 경력 인테리어 전문 기업 스페이스온",
  },
};

export default function SpaceOnPage() {
  return (
    <>
      <NavbarSection />
      <main>
